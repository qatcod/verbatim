        ...
        state.save_extraction(
            ...
            ExtractionResult(
                ...
                commitments=[Commitment(
                    actor="Qat", deliverable="ship the migration",
                ...
                decisions=[Decision(
                    ...
                    sources=[SourceReference(verbatim_quote="postgres it is.", speaker="Qat", rationale="r")],
                )],
                open_questions=[OpenQuestion(
                    topic="budget", question="What's the API budget?",
                    raised_by="Taz", confidence=Confidence.MEDIUM,
                    sources=[SourceReference(verbatim_quote="any budget?", speaker="Taz", rationale="r")],
                )],
                blockers=[Blocker(
                    blocked_thing="public ship", blocked_by="legal review",
                    owner="Taz", confidence=Confidence.LOW,
                    sources=[SourceReference(verbatim_quote="need legal.", speaker="Jason", rationale="r")],
                )],
            ),
